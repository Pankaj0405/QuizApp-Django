...
class UserLoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Enter your college email id'}))
    # password = forms.CharField(widget=forms.PasswordInput,help_text = "Pankaj@1234")
